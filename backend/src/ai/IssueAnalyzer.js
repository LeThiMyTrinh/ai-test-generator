...
class IssueAnalyzer {
    constructor() {
        ...
        // Issue type categories — 8 groups matching PDF "Kiểm tra giao diện" checklist
        this.categories = {
            layoutUI: ['NAVIGATION_ERROR', 'HORIZONTAL_SCROLLBAR', 'OVERFLOW_X', 'OUTSIDE_VIEWPORT', 'RESPONSIVE_HIDDEN', 'ELEMENT_OVERLAP', 'EMPTY_CONTAINER', 'IRREGULAR_SPACING', 'ALIGNMENT_OFF', 'TOO_MANY_FONTS', 'FONT_NOT_LOADED'],
            uiComponents: ['INPUT_WITHOUT_LABEL', 'FORM_NO_SUBMIT', 'PLACEHOLDER_AS_LABEL', 'MISSING_AUTOCOMPLETE', 'SMALL_TOUCH_TARGET'],
            textContent: ['FONT_SIZE_TOO_SMALL', 'LINE_HEIGHT_TIGHT', 'TEXT_TRUNCATED', 'MISSING_LANG', 'MISSING_TITLE', 'HEADING_SKIP', 'MULTIPLE_H1'],
            imageIcon: ['BROKEN_IMAGE', 'MISSING_ALT', 'DISTORTED_IMAGE', 'OVERSIZED_IMAGE', 'NO_WEBP_SUPPORT'],
            scrollPosition: ['NO_LAZY_LOADING', 'CLS_PRONE'],
            loadingAnimation: ['JS_ERROR', 'CONSOLE_ERROR', 'RENDER_BLOCKING_SCRIPT', 'TOO_MANY_THIRD_PARTY'],
            accessibility: ['LOW_CONTRAST', 'COLOR_INCONSISTENCY', 'UNREADABLE_ON_BG', 'ACCESSIBILITY', 'MISSING_VIEWPORT_META'],
            linkNavigation: ['BROKEN_LINK', 'MISSING_META_DESC', 'MISSING_OG_TAGS', 'MISSING_FAVICON'],
        };
    }
