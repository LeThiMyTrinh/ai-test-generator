...
const TEMPLATE_PATH = path.join(__dirname, '../templates/performance-report.ejs');
...
class PerformanceReporter {
    /**
     * Generate HTML report from performance test history record
    ...
    async generateHTML(record, options = {}) {
        ...
        const filename = `perf-report-${record._id}.html`;
